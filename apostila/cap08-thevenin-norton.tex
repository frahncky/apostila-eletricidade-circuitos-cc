...
\end{alternativas}
\resposta{(b)}
\resolucao{Para determinar $R_{\text{Th}}$, desligam-se as fontes independentes (tensão
...
\]
\textbf{Vantagem do método:} uma vez obtido o equivalente, testar qualquer carga
...
= \SI{4}{\ampere}$. Resultado consistente.}
\end{questao}
...
$R_{\text{Th}}=\SI{3}{\ohm}$. Deseja-se saber, sem refazer os cálculos para cada
...
\item Qual é a corrente de curto-circuito nos terminais?
