...
Um RLC em série tem $R=\SI{10}{\ohm}$, $L=\SI{50}{\milli\henry}$ e
...
Para um RLC em série com $R=\SI{40}{\ohm}$, $L=\SI{50}{\milli\henry}$ e
...
Calcule $R_{\mathrm{crit}}$ para um RLC em série com $L=\SI{0.1}{\henry}$ e
...
Um RLC em paralelo possui $R=\SI{200}{\ohm}$, $C=\SI{100}{\micro\farad}$ e
...
Após uma comutação, um RLC em série fica sem fonte independente e possui
