...
\input{cap06-superposicao}           % Teorema da Superposicao
...
\input{cap08-thevenin-norton}        % Thevenin e Norton

% Cap. 9 -------------------------------------------------------------
\setcounter{section}{8}
\input{cap09-maxwell-integrado}      % Maxwell / malhas + dependentes por nivel
