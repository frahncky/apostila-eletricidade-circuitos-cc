...
\input{cap07-analise-nodal}          % Analise nodal
...
\input{cap09-maxwell}                % Metodo de Maxwell / malhas
\input{bancos/banco-fontes-dependentes-malhas} % banco visual adicional
