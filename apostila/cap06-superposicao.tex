...
$\dfrac{12-V}{6}+\dfrac{6-V}{6}=\dfrac{V}{3}\Rightarrow V=\SI{4.5}{\volt}$. Confere.}
\end{questao}
...
\Rightarrow V_A = \SI{11}{\volt}$. Confere.}
\end{questao}
...
completas; a nodal resolveu com \emph{uma} equação. Isso ilustra que a
