...
SUBSTITUICOES = [
    ...
    ("Um RLC em série", "Um circuito RLC em série"),
    ("um RLC em série", "um circuito RLC em série"),
    ("Para um RLC em série", "Para um circuito RLC em série"),
    ("Em um RLC em série", "Em um circuito RLC em série"),
    ("Um RLC em paralelo", "Um circuito RLC em paralelo"),
    ("um RLC em paralelo", "um circuito RLC em paralelo"),
    ("Para um RLC em paralelo", "Para um circuito RLC em paralelo"),
    ("Em um RLC em paralelo", "Em um circuito RLC em paralelo"),
...
SUBSTITUICOES_EXATAS = [
    ...
    ("$\\alpha<\\omega_0$, é subamortecido e",
