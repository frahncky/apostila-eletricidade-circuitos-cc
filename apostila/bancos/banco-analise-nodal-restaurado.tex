...
\resolucao{
\[
G_1=\tfrac14=\SI{0.25}{\ensuremath{\mathrm{S}}},\quad
G_2=\tfrac15=\SI{0.20}{\ensuremath{\mathrm{S}}},\quad
G_3=\tfrac1{20}=\SI{0.05}{\ensuremath{\mathrm{S}}}.
\]
\[
G=0{,}25+0{,}20+0{,}05=\SI{0.5}{\ensuremath{\mathrm{S}}}
\;\Longrightarrow\;
...
de $\SI{0.1}{\ensuremath{\mathrm{S}}}$ --- um resistor "sintético" de $\SI{10}{\ohm}$. Se o
...
com $g=\SI{0.1}{\ensuremath{\mathrm{S}}}$. Determine $V_1$ e $V_2$.
...
$G_{11}=\SI{0.3}{\ensuremath{\mathrm{S}}}$, $G_{22}=\SI{0.2}{\ensuremath{\mathrm{S}}}$,
$G_{12}=G_{21}=\SI{-0.1}{\ensuremath{\mathrm{S}}}$, com $\SI{4}{\ampere}$ injetados no nó 1 e
$\SI{1}{\ampere}$ no nó 2.
...
$\SI{0.1}{\ensuremath{\mathrm{S}}}$ entre os nós:
\[
...
indefinidamente a célula: um resistor em série de $\SI{10}{\ohm}$ seguido de um
...
(b) Cada nó vê $R_\infty$ à sua frente, atrás de um resistor em série de
...
\end{itensq}
\resposta{(a) $V=\dfrac{1}{1/R-g}$; (b) $g_c=1/R=\SI{0.05}{\ensuremath{\mathrm{S}}}$;
...
\]
(b) Em $g_c=1/R=\SI{0.05}{\ensuremath{\mathrm{S}}}$ o denominador se anula: a matriz
...
e o nó "flutua". Valores próximos: $g=\SI{0.02}{\ensuremath{\mathrm{S}}}\Rightarrow
V=\SI{33.3}{\volt}$; $g=\SI{0.049}{\ensuremath{\mathrm{S}}}\Rightarrow V=\SI{1000}{\volt}$ ---
...
1{,}0001 & -1{,}0000\\
-1{,}0000 & 1{,}0001
\end{bmatrix}\si{\ensuremath{\mathrm{S}}}.
\]
\begin{itensq}
...
(b) O acoplamento entre os nós ($\SI{1}{\ensuremath{\mathrm{S}}}$, ou $\SI{1}{\ohm}$) é
$10^{4}$ vezes maior que a condutância ao terra ($\SI{1e-4}{\ensuremath{\mathrm{S}}}$, ou
...
$\si{\milli\ensuremath{\mathrm{S}}}$ e $\si{\kilo\ohm}$ equilibra as ordens de grandeza da
...
$\mathbf{G}=\begin{bmatrix}0{,}3&-0{,}1\\-0{,}1&0{,}2\end{bmatrix}\si{\ensuremath{\mathrm{S}}}$:
\begin{itensq}
