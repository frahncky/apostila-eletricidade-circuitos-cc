...
classifique os casos $g=\SI{0.4}{\milli\siemens}$,
$\SI{0.5}{\milli\siemens}$ e $\SI{0.6}{\milli\siemens}$ para
...
\resposta{$g_{\mathrm{crit}}=1/R=\SI{0.5}{\milli\siemens}$; para
\SI{0.4}{\milli\siemens}: estável, $\tau=\SI{1}{\second}$; para
\SI{0.5}{\milli\siemens}: polo em zero; para \SI{0.6}{\milli\siemens}:
...
$g_{\mathrm{crit}}=\SI{0.5}{\milli\siemens}$. Para $g=0{,}4\,\mathrm{mS}$,
...
\end{circuitikz}}{Projeto do amortecimento de um RLC paralelo usando uma VCCS.}

\resposta{$g_{\mathrm{crit}}\approx\SI{53.25}{\milli\siemens}$; abaixo desse
...
\[
\frac1R+g=2C\omega_0
=2(100\times10^{-6})(316{,}23)\approx\SI{63.25}{\milli\siemens}.
\]
Como $1/R=\SI{10}{\milli\siemens}$,
$g_{\mathrm{crit}}\approx\SI{53.25}{\milli\siemens}$. Reduzir $g$ reduz
