...
\begin{circuitikz}[american,scale=.96,transform shape,line width=.8pt]
  \coordinate (g) at (5.2,0);
  \coordinate (a) at (5.2,4.4);
  \draw (0,0) to[\fonteV,l^={$\SI{30}{\volt}$}] (0,4.4)
        -- (1.4,4.4) to[R,l^={$\SI{10}{\ohm}$}] (a);
  \draw (a) to[R,l_={$\SI{15}{\ohm}$}] (g) -- (0,0);
  \fill (a) circle (1.2pt);
  \node[Vcol,fill=white,inner sep=1.8pt] at ($(a)+(.85,.58)$) {$V_A$};
  \node[ground] at(g){};
\end{circuitikz}}
...
\begin{circuitikz}[american,scale=.82,transform shape,line width=.8pt]
  ...
  \coordinate (n1) at (4.3,4.8);
  \coordinate (n2) at (10.3,4.8);
  \draw (0,0) to[\fonteV,l^={$\SI{24}{\volt}$}] (0,4.8)
        -- (1.2,4.8) to[R,l^={$\SI{6}{\ohm}$}] (n1);
  \draw (n1) to[R,l_={$\SI{12}{\ohm}$}] (g);
  \draw (n1) to[isource,l_={$\SI{2}{\ampere}$}] (n2);
  \draw (n2) to[R,l={$\SI{6}{\ohm}$}] (10.3,0) -- (g) -- (0,0);
  \fill (n1) circle (1.2pt);
  \fill (n2) circle (1.2pt);
  \node[Vcol,fill=white,inner sep=1.8pt] at ($(n1)+(0,.86)$) {$V_1$};
  \node[Vcol,fill=white,inner sep=1.8pt] at ($(n2)+(0,.86)$) {$V_2$};
...
\begin{circuitikz}[american,scale=.84,transform shape,line width=.8pt]
  ...
  \coordinate (n1) at (2.3,4.6);
  \coordinate (n2) at (8.2,4.6);
  \draw (0,0) to[isource,l^={$\SI{3}{\ampere}$}] (0,4.6) -- (n1);
  \draw (n1) to[R,l_={$\SI{4}{\ohm}$}] (g);
  \draw (n1) to[R,l^={$\SI{8}{\ohm}$}] (n2);
  \draw (n2) to[cvsource,l_={$2V_1$}] (8.2,0) -- (g) -- (0,0);
  \fill (n1) circle (1.2pt);
  \fill (n2) circle (1.2pt);
  \node[Vcol,fill=white,inner sep=1.8pt] at ($(n1)+(0,.82)$) {$V_1$};
  \node[Vcol,fill=white,inner sep=1.8pt] at ($(n2)+(0,.82)$) {$V_2$};
