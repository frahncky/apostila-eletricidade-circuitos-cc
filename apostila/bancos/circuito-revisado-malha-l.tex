...
\draw[->,loopcol,line width=1.05pt] (1.45,3.55) arc[start angle=0,end angle=-305,radius=.34cm];
\node[loopcol,fill=white,inner sep=1pt] at(1.45,3.55){\footnotesize$I_1$};
\draw[->,loopcol,line width=1.05pt] (4.95,3.55) arc[start angle=0,end angle=-305,radius=.34cm];
\node[loopcol,fill=white,inner sep=1pt] at(4.95,3.55){\footnotesize$I_2$};
\draw[->,loopcol,line width=1.05pt] (4.95,1.00) arc[start angle=0,end angle=-305,radius=.34cm];
