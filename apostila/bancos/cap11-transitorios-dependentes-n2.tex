...
VCCS de valor $g v_C$, com $g=\SI{0.25}{\milli\siemens}$. Determine a constante de
tempo, o valor final de $v_C$ e $v_C(\SI{0.10}{\second})$.

\circuitoqq{%
\begin{circuitikz}[scale=1,transform shape,line width=0.8pt]
\draw (0,0) to[american current source,l_={$3u(t)\,\mathrm{mA}$}] (0,3) -- (6.5,3);
\draw (2.2,3) to[R,l={$R=\SI{4}{\kilo\ohm}$}] (2.2,0);
\draw (4.3,3) to[C,l={$C=\SI{50}{\micro\farad}$},v^>={$v_C$}] (4.3,0);
\draw (6.5,3) to[american controlled current source,l_={$g v_C$}] (6.5,0) -- (0,0);
...
capacitor é
\[
G_{\mathrm{eq}}=\frac1R+g=\SI{0.25}{\milli\siemens}+
\SI{0.25}{\milli\siemens}=\SI{0.50}{\milli\siemens},
\]
...
$g=\SI{0.5}{\milli\siemens}$. Determine $R_{\mathrm{eq}}$, $\tau$ e $v_C(t)$.
...
\draw (6,3) to[american controlled current source,l_={$g v_C$}] (6,0);
...
$G_{\mathrm{eq}}=1/R+g=\SI{0.5}{\milli\siemens}+
\SI{0.5}{\milli\siemens}=\SI{1}{\milli\siemens}$. Logo
...
\draw (0,0) -- (6,0);
\draw (0,3) -- (6,3);
\draw (1.8,3) to[R,l={$R=\SI{20}{\ohm}$},i>^={$i_x$}] (1.8,0);
\draw (3.9,3) to[L,l={$L=\SI{200}{\milli\henry}$},i>^={$i_L$}] (3.9,0);
\draw (6,0) to[american controlled current source,l_={$\beta i_x$}] (6,3);
