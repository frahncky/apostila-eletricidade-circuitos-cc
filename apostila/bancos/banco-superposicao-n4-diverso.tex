...
\draw (0,0) to[\fonteV,l^={$E_1$}] (0,4.1) to[R,l={$R_1$}] (a);
\draw (10,0) to[\fonteV,l_={$E_3$}] (10,4.1) to[R,l_={$R_3$}] (a);
\draw (7.7,0) to[isource,l_={$I_2$}] (7.7,4.1)--(a);
\draw (a) to[R,l_={$R_L$}] (g); \draw (0,0)--(g)--(7.7,0)--(10,0); \node[ground] at(g){};
\end{circuitikz}}
...
\draw (0,0) to[isource,l^={$I_1$}] (0,3.6)--(3.5,3.6) to[R,l={$R$},i>^={$I$}] (3.5,0)--(0,0);
\draw (6.5,0) to[isource,l_={$I_2$}] (6.5,3.6)--(3.5,3.6); \draw (6.5,0)--(3.5,0);
\end{circuitikz}}
...
\coordinate (g) at (4.2,0); \coordinate (a) at (4.2,4);
\draw (0,0) to[\fonteV,l^={$E=\SI{15}{\volt}$}] (0,4) to[R,l={$\SI{5}{\ohm}$}] (a);
\draw (a) to[R,l_={$\SI{10}{\ohm}$}] (g)--(0,0);
\draw (8.2,0) to[isource,l_={$\SI{1}{\ampere}$}] (8.2,4)--(a); \draw (8.2,0)--(g);
...
\circuitoq{\begin{circuitikz}[american,scale=.88,transform shape]
\draw (0,0) to[\fonteV,l^={$E_1=\SI{30}{\volt}$}] (0,3.5) to[R,l={$R=\SI{10}{\ohm}$},i>^={$I$}] (5.2,3.5)
 to[\fonteV,l_={$E_2$},invert] (5.2,0)--(0,0);
\end{circuitikz}}
...
\circuitoq{\begin{circuitikz}[american,scale=.78,transform shape]
\coordinate (g) at (3.8,0); \coordinate (a) at (3.8,4);
\draw (a) to[R,l_={$\SI{1}{\kilo\ohm}$}] (g);
\draw (0,0) to[cisource,l^={$0{,}5\,\mathrm{mS}\,V_A$}] (0,4)--(a); \draw (0,0)--(g);
\draw (7.5,0) to[isource,l_={$I_t$}] (7.5,4)--(a); \draw (7.5,0)--(g);
\node[above,Vcol] at(a){$V_A$}; \node[ground] at(g){};
\end{circuitikz}}
...
\draw (2.4,0) to[isource,l^={$I_2$}] (2.4,3)--(a);
\draw (10,0) to[\fonteV,l_={$E_3$}] (10,4.2) to[R,l_={$R_3$}] (a);
\draw (8,0) to[isource,l_={$I_4$}] (8,3)--(a);
\draw (a) to[R,l_={$R_L$}] (g); \draw (0,0)--(2.4,0)--(g)--(8,0)--(10,0); \node[above,Vcol] at(a){$V_o$}; \node[ground] at(g){};
\end{circuitikz}}
...
\circuitoq{\begin{circuitikz}[american,scale=.78,transform shape]
\draw (0,0) to[\fonteV,l^={$E_1$}] (0,3.8) to[R,l={$R_1$}] (3.5,3.8) coordinate(a);
\draw (7.2,0) to[\fonteV,l_={$E_2$}] (7.2,3.8) to[R,l_={$R_2$}] (a);
\draw (a) to[R,l_={$R_L$}] (3.5,0)--(0,0); \draw (7.2,0)--(3.5,0);
\node[above,Vcol] at(a){$V_o$};
\node[right,align=left,font=\footnotesize] at (8.2,1.8) {fonte real com\\limitação de corrente};
\end{circuitikz}}
