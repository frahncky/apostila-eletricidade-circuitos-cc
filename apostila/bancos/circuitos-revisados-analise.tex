...
% ----------------------------- MALHAS ---------------------------------
% N2 original: fonte independente fora da area das setas e correntes de malha
% deslocadas para baixo, evitando sobreposicao com tensoes e resistores.
\newcommand{\fvMalhaNDoisQOneRevisada}{%
\begin{circuitikz}[american,scale=.95,transform shape,line width=.8pt]
  ...
  \draw[->,loopcol,line width=1.15pt] (1.55,1.05) arc(0:305:.38);
  \node[loopcol,fill=white,inner sep=1pt] at(1.55,1.05){\footnotesize$I_1$};
  \draw[->,loopcol,line width=1.15pt] (4.85,1.05) arc(0:305:.38);
  \node[loopcol,fill=white,inner sep=1pt] at(4.85,1.05){\footnotesize$I_2$};
\end{circuitikz}}

\newcommand{\fvMalhaNDoisQTwoRevisada}{%
\begin{circuitikz}[american,scale=.95,transform shape,line width=.8pt]
...
\newcommand{\fvMalhaNDoisQThreeRevisada}{%
\begin{circuitikz}[american,scale=.95,transform shape,line width=.8pt]
