...
\begin{questao}[2]{}
Determine o equivalente de Thévenin da fonte de Norton com resistor em série até a porta.
\circuitoq{\begin{circuitikz}[american,scale=.82,transform shape,line width=.8pt]
...
\resolucao{Em vazio o resistor em série de 2 k$\Omega$ não conduz, então $V_{Th}=5$ mA$\times3$ k$\Omega=15$ V. Com a fonte aberta, $R_{Th}=3+2=5$ k$\Omega$.}
\end{questao}
