...
\begin{questao}[4]{}
Projete o RLC série abaixo para que a resposta do capacitor a um degrau seja
...
\draw (0,0) to[american voltage source,l_={$V_su(t)$}] (0,3)
      ...
      -- (7.5,0) -- (0,0);
\end{circuitikz}}{Projeto de um RLC série a partir de especificações transitórias.}
...
Para RLC série, $\zeta=R/(2L\omega_0)$; portanto
...
\begin{questao}[4]{}
No circuito RLC paralelo, a fonte de corrente vale $\SI{2}{\ampere}$ por muito
...
\end{circuitikz}}{RLC paralelo excitado por uma mudança de nível da fonte de corrente.}
